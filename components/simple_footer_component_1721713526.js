...
*/
Vue.component("simple_footer_component_1721713526", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EtherScan - Real-time Ethereum Transaction Analyzer
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with EtherScan's cutting-edge transaction analysis tools. Monitor new Ethereum transactions as they happen and gain invaluable insights into the ever-evolving blockchain landscape.
                    </div>
                </div>
            </div>
        </footer> 
